...
public class CelebsTnAdapter extends BaseAdapter {
    Context mContext;
    String[] strCompat;


    public CelebsTnAdapter(Context context, String[] strCompat) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if(view == null)
            view = mInflater.inflate(R.layout.item_array_good, parent, false);
